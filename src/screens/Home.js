            ...
            <div className="container marketing">
              ...
              <div className="row">
                <div className="col-lg-4">
                  ...
                  <p>
                    If little steps are what it takes to lay the road to a
                    successful career in life, then the gait with you take each
                    step, matters a lot. A step-by-step list of preparation tips
                    and strategies
                  </p>
                  <p>
                    {" "}
                    <Link className="btn btn-secondary" to="/prepareplacement">
                      View details »
                    </Link>
                  </p>
                </div>
                ...
                <div className="col-lg-4">
                  ...
                  <p>
                    ...
                    Prove your skills, win prizes, practice coding with other
                    coders, have fun.
                  </p>
                  <p>
                    <Link
                ...
                <div className="col-lg-4">
                  ...
                  <p>
                    {" "}
                    <Link className="btn btn-secondary" to="/showquestion">
                      View details »
                    </Link>
                  </p>
                </div>
